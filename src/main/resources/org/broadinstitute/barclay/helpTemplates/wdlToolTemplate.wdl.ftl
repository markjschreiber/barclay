...
<#if beta?? && beta == true>
# Run ${name} (**BETA**) (WDL auto generated from: Tool Version ${version})
<#elseif experimental?? && experimental == true>
# Run ${name} **EXPERIMENTAL** ${name} (WDL autogenerated from: Tool Version ${version})
<#else>
# Run ${name} (WDL auto generated from: Tool Version ${version})
</#if>
#
# ${summary}
#
